      ...
      case "Setting":
          ...
          case "Vote":
            if(msgID.equals("701")) {
			  ...
			  record.putPair("msgID", "711");
			  record.removePair("MessageType");
			  ...
			  //encoder.sendMsg(record); // send acknowledge vote 711, status 1: duplicate 2: invalid, 3: valid
            }
			break;
          ...
          case "Admin":
            ...
            switch (msgID) {
				...
				case "702": //REQUEST REPORT
					...
					// send acknowledgement 712 message
					record.putPair("msgID", "712");
					record.putPair("RankedReport", rankedReport);
